...
/* Dropdown menus & date-picker calendars (BaseWeb popovers).
   Under the dark base theme the popover surface is dark, so text must be cream —
   the old rule forced dark text (#1f2b18), correct only for a light theme, which
   made dropdowns/calendars unreadable (dark-on-dark). */
div[data-baseweb="popover"] ul,
div[data-baseweb="popover"] [role="listbox"],
div[data-baseweb="popover"] [data-baseweb="menu"],
div[data-baseweb="calendar"],
div[data-baseweb="calendar"] > div {
    background-color: #17210f !important;
    border: 1px solid rgba(255,255,255,.14) !important;
...
div[data-baseweb="calendar"] button:hover {
    background-color: rgba(142,185,87,.22) !important;
}
div[data-baseweb="popover"] [aria-selected="true"],
div[data-baseweb="calendar"] [aria-selected="true"] {
    background-color: rgba(142,185,87,.32) !important;
}
...
def render_score_section(score_result: ScoreResult, result: AnalysisResult) -> None:
    ...
    st.plotly_chart(gauge_fig, use_container_width=True, config=PLOTLY_CONFIG, theme=None)
...
def render_invest_simulation_tab(
    ...
    st.plotly_chart(value_fig, use_container_width=True, config=PLOTLY_CONFIG, theme=None)
