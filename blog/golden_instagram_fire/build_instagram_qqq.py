...
CONFIG = {
    "QQQ": {"prefix": "qqq", "ticker": "QQQ", "x1": 2030,
    ...
    "TQQQ": {"prefix": "tqqq", "ticker": "TQQQ", "x1": 2027,
    ...
    "JEPQ": {"prefix": "jepq", "ticker": "JEPQ", "x1": 2027,
             "sub": "2022년 은퇴 · 4년 경과 · 물가연동 인출 · 배당 생활비 사용",
             "note": "$40만·$80만 모두 월 $4,000 인출까지 생존(4년).\n"
                     "2022 상장 직후 하락도 나스닥 고배당 인컴으로 버팀."},
