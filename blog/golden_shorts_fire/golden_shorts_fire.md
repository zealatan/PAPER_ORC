...
- 2026-07-29(마감): 원금 **전환 카운트업**·그래프 **960px 세이프존**(종이 full-width·양옆 여백)·**은퇴원금 형광펜**·**배투실 워터마크**. **현재 정본(freeze).**
- 2026-07-29(멀티에이전트 리뷰 반영): 테이블 **헤더 글씨=본문 크기**·끝점 **$10M↑ 축약(fmtV)**·NOTE **세금 통화별**·편집기 **ACCUM_TOTAL 인트로/전환 포함**·THUMB 유령키 제거.
- 2026-07-30: **애플(AAPL)** 종목 추가(START_YEAR 2016·애플 로고 실루엣). 끝점 라벨 **겹침 회피 재작성**(위→아래·x근접시만 30px, 프로즌 참조 픽셀 동일). 테이블 **경고 문구(DISC)** 추가.
