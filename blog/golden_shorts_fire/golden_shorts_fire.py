...
_PREF={"PG":"pg","QQQ":"qqq","KTNG":"ktng","SCHD":"schd","SPY":"spy","MO":"mo","SEC":"sec","AAPL":"aapl","QYLD":"qyld"}.get(_STOCK,"pg")
...
if _STOCK=="QQQ":
    ...
    LOGO='<text x="100" y="62" text-anchor="middle" font-family="Pretendard,sans-serif" font-weight="900" font-size="46" fill="#1b3660">QYLD</text>'; LOGOVB="0 0 200 87.021"; COMPANY="QYLD · Global X 커버드콜"; TITLE="나스닥100 커버드콜"
elif _STOCK=="SCHD":
