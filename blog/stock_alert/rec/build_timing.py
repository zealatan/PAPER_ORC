...
HTML = os.path.join(ROOT, 'deck', 'stock_alert_final.html')       # PACE·SUBS 소스
DECK = os.path.join(ROOT, 'deck', 'stock_alert_deck.json')        # 입력 덱
MANI = os.path.join(HERE, 'tts_manifest.json')
OUT_DECK = os.path.join(ROOT, 'deck', 'stock_alert_deck_dubbed.json')  # 타이밍 반영 덱
