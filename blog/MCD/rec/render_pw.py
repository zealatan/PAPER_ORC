...
URL = "http://127.0.0.1:8080/deck/mcd_dubbed.html?rec"
import json as _json, re as _re
_d = _json.load(open(os.path.join(ROOT,'deck','mcd_deck_dubbed.json'), encoding='utf-8'))['scenes']
_PACE = float(_re.search(r'var PACE\s*=\s*([\d.]+)', open(os.path.join(ROOT,'deck','mcd_final.html'),encoding='utf-8').read()).group(1))
