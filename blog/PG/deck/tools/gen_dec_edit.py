...
EDIT_CSS = ("*{box-sizing:border-box}html,body{margin:0;height:100%}"
            ...
            ".subs .lns{display:flex;flex-direction:column;gap:9px}"
            ".subs .ln{font-size:19px;line-height:1.55;font-weight:600;color:#17282a;border-left:4px solid #c98a1a;"
            "padding:11px 14px;border-radius:0 8px 8px 0;background:#fbf6ea;outline:none;cursor:text;transition:box-shadow .12s}"
            ".subs .ln:hover{background:#fdfaf0}"
            ".subs .ln:focus{background:#fff;box-shadow:inset 0 0 0 2px #c98a1a,0 2px 8px rgba(60,45,25,.12)}"
